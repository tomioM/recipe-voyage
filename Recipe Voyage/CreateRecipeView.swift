...
struct CreateRecipeView: View {
    ...
    // MARK: - Header Bar
        ...
        func ancestryCardRow(for step: EditableAncestry, at index: Int) -> some View {
            HStack(spacing: 8) {
        ...
        func audioRecordingSidebar(geometry: GeometryProxy) -> some View {
            ScrollView {
                VStack(spacing: 20) {
                    // Recording Block
                    VStack(spacing: 16) {
        ...
        func saveButton(geometry: GeometryProxy) -> some View {
            VStack {
                Spacer()
